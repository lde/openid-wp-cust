...
<tr valign="top">
					<th scope="row"><?php _e('Disallow Password authentification', 'openid') ?></th>
					<td>

						<p><?php //printf(__('Forbidden password authentification for users who have openid enabled on their account', 'openid')); 
						?>
						</p>
						<p>
						
<label for="openid_when_used_disable_password">
		<input type="checkbox" name="openid_when_used_disable_password" id="openid_when_used_disable_password" value="1"
			<?php checked(true, get_option('openid_when_used_disable_password')) ?> />
		<?php _e('Disable Password auth for accounts with openid enabled', 'openid') ?>
	</label>
